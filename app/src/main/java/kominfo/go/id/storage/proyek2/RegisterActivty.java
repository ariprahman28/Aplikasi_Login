...
public class RegisterActivty extends AppCompatActivity {
    EditText editUsername,editPassword,editEmail,editNamaLengkakp,editAsalSekolah,editAlamat;
    Button btnSimpan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editNamaLengkakp = findViewById(R.id.editNamaLengkap);
        ...
        @Override
            ...
            if (isValidation()){
                ...
                Toast.makeText(RegisterActivty.this,"Mohon Lengkapi Seluruh Data",Toast.LENGTH_LONG).show();
...
boolean isValidation() {
    if (editUsername.getText().toString().equals("") ||
            ...
            editNamaLengkakp.getText().toString().equals("") ||
    ...
    String isiFile = editUsername.getText().toString() + ";" +
            ...
            editNamaLengkakp.getText().toString()+ ";" +
